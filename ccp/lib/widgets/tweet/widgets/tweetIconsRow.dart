...
import 'package:ccp/page/common/usersListPage.dart';
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          _iconWidget(
            ...
            icon: AppIcon.reply,
            sysIcon: Icons.chat_bubble_outline,
            iconColor: iconColor,
            size: size ?? 20,
            onPressed: () {
          ...
          _iconWidget(context,
              ...
              icon: model.likeList.any((userId) => userId == authState.userId)
                ? AppIcon.heartFill
                : AppIcon.heartEmpty,
              sysIcon: model.likeList.any((userId) => userId == authState.userId) ? Icons.favorite : Icons.favorite_border,
              iconColor: model.likeList.any((userId) => userId == authState.userId) ? CcpColor.primary : iconColor,
              size: size ?? 20, 
              onPressed: () {
