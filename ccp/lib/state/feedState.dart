...
class FeedState extends AppState {
  ...
  //temp
  static User usertemp = User(email: "vikash@gmail.com", userId: "1234", displayName: "Mintu Duck", profilePic: dummyProfilePic, key: "1", contact: "12333", bio: "President of Duck", dob: "22222", primaryLocation: "Intenet", createdAt: "Home", userName: "Duck123", isVerified: true, followers: 1234334, following: 7, fcmToken: "ghanta", followersList: ["alpha", "beta"]); //ToDO remove this after integrating it backend
  ...
  void getDataFromDatabase() {
    try {
      ...
      _feedlist = null;
      notifyListeners();
      User usertmp1 = User(email: "vikash@gmail.com", userId: "1234", displayName: "Chintu Duck", profilePic: dummyProfilePicList[4], key: "133", contact: "12333", bio: "President of Duck", dob: "22222", primaryLocation: "Intenet", createdAt: "Home", userName: "Duck123", isVerified: true, followers: 1234334, following: 7, fcmToken: "ghanta", followersList: ["alpha", "beta"]); //ToDO remove this after integrating it backend
      User usertmp2 = User(email: "vikash@gmail.com", userId: "123466", displayName: "Pitroda Duck", profilePic: dummyProfilePicList[2], key: "13343", contact: "12333", bio: "President of Duck", dob: "22222", primaryLocation: "Intenet", createdAt: "Home", userName: "Duck123", isVerified: true, followers: 1334, following: 7, fcmToken: "ghanta", followersList: ["alpha", "beta"]); //ToDO remove this after integrating it backend
      User usertmp3 = User(email: "vikash@gmail.com", userId: "123456666", displayName: "Pintu Duck", profilePic: dummyProfilePicList[1], key: "123343", contact: "12333", bio: "President of Duck", dob: "22222", primaryLocation: "Intenet", createdAt: "Home", userName: "Duck123", isVerified: true, followers: 14334, following: 7, fcmToken: "ghanta", followersList: ["alpha", "beta"]); //ToDO remove this after integrating it backend
