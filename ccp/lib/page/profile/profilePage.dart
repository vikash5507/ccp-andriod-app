...
import 'package:ccp/page/profile/widgets/tabPainter.dart';
...
class _ProfilePageState extends State<ProfilePage>
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      print("Profile Page init method!");
      print(authstate.isbusy);
  ...
  SliverAppBar getAppbar() {
    ...
    print("inside ProfilePage Appbar!");
    print(authstate.isbusy);
    ...
    return SliverAppBar(
      ...
      elevation: 0,
      stretch: true,
      iconTheme: IconThemeData(color: CcpColor.white),
      //backgroundColor: Colors.transparent,
      backgroundColor: CcpColor.secondary,
      title: Text(
        authstate.userModel.displayName,
        style: TextStyle(color: CcpColor.white),
      ),
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        //title: Text(authstate.userModel.displayName, style: TextStyle(color: CcpColor.white),),
        //centerTitle: true,
                        ...
                        AnimatedContainer(
                          ...
                          child: RippleButton(
                            child: customImage(
                              context,
                              authstate.userModel
                                  .profilePic, //ToDO find out what profileUserModel variable does
      ...
      //bottom: PreferredSize(child: Text(authstate.userModel.displayName, style: TextStyle(color: CcpColor.white),), preferredSize: Size.fromHeight(20.0)),
      // bottom: TabBar(
  ...
  build(BuildContext context) {
    print("Inside Profile Page build!");
        ...
        body: NestedScrollView(
          ...
          headerSliverBuilder: (BuildContext context, bool boxIsScrolled) {
            return <Widget>[
                  ...
                  : SliverToBoxAdapter(
                      child: Container(
                        ...
                        child: authstate.isbusy
                            ? SizedBox.shrink()
                            : UserNameRowWidget(
                                //user: authstate.profileUserModel,//ToDo
              ...
              SliverPersistentHeader(
                pinned: true,
                delegate: TwitterTabs(50.0, _tabController),
              ),
              // SliverList(
          ...
          body: TabBarView(
            ...
            children: [
              ...
              PageStorage(child: _tweetList("tab1", context, authstate, list, false, false), bucket: bucket),

              /// Display all reply tweet list
              PageStorage(child: _tweetList("tab2", context, authstate, list, true, false), bucket: bucket),

              /// Display all reply and comments tweet list
              PageStorage(child: _tweetList("tab3", context, authstate, list, false, true), bucket: bucket)
            ],
          ),
        ),
      ),
  ...
  Widget _tweetList(String key, BuildContext context, AuthState authstate,
            ...
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ...
                      : '${authstate.userModel.userName} hasn\'t ${isreply ? 'reply to any Tweet' : isMedia ? 'post any media Tweet yet' : 'post any Tweet yet'}',
                  //ToDo: '${authstate.profileUserModel.userName} hasn\'t ${isreply ? 'reply to any Tweet' : isMedia ? 'post any media Tweet yet' : 'post any Tweet yet'}',
...
class TwitterTabs extends SliverPersistentHeaderDelegate {
  ...
  TwitterTabs(this.size, this._tabController);

  @override
  Widget build(
      BuildContext context, double shrinkOffset, bool overlapsContent) {
        //print("_tabController.offset in tabs: "+_tabController.indexIsChanging.toString());
    return Container(
      color: Colors.white,
      height: size,
      child: TabBar(
