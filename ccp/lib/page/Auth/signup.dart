    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            _entryFeild(getTranslated(context, 'singup_page-form_name'), controller: _nameController),
            _entryFeild(getTranslated(context, 'singup_page-form_email'),
                controller: _emailController, isEmail: true),
            // _entryFeild('Mobile no',controller: _mobileController),
            _entryFeild(getTranslated(context, 'singup_page-form_password'),
                controller: _passwordController, isPassword: true),
            _entryFeild(getTranslated(context, 'singup_page-form_confirm_password'),
  ...
  Widget _submitButton(BuildContext context) {
    return Container(
      ...
      child: FlatButton(
        ...
        child: Text(getTranslated(context, 'singup_page-title'), style: TextStyle(color: Colors.white)),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: customText(
          getTranslated(context, 'singup_page-title'),
          context: context,
