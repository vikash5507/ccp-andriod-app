 ...
 final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
    ...
    padding: EdgeInsets.symmetric(horizontal: 30),
      child:Column(
        ...
        children: <Widget>[
          _label(),
          SizedBox(height: 50,),
          _entryFeild(getTranslated(context, "forget_pass_page-input_msg"),controller: _emailController),
          // SizedBox(height: 10,),
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
           borderRadius: BorderRadius.all(Radius.circular(30.0)),
              borderSide: BorderSide(color: CcpColor.primary)),
  ...
  Widget _submitButton(BuildContext context){
    return Container(
      ...
      child: FlatButton(
        ...
        child: Text(getTranslated(context, 'forget_pass_page-button'),style:TextStyle(color: CcpColor.white)),
      )
    );
  }
  Widget _label(){
    return Container(
      child:Column(
        children: <Widget>[
          customText(getTranslated(context, 'forget_pass_page-heading'),style:TextStyle(fontSize: 24,fontWeight: FontWeight.bold)),
          SizedBox(height: 15),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 20),
            child: customText(getTranslated(context, 'forget_pass_page-heading_msg'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: customText(getTranslated(context, 'forget_pass_page-title'),context: context,style: TextStyle(fontSize: 20)),
        centerTitle: true,
